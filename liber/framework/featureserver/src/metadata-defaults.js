...
const FULL_VERSION = '11.3.0';
const MAX_RECORD_COUNT = 2000;
const SERVICE_DESCRIPTION =
  'This is a feature service powered by custom data feeds runtime. Service Description information may not be available for all services.';
const LAYER_DESCRIPTION =
  'This is a feature service powered by custom data feeds runtime. Layer Description information may not be available for all layers.';
const COPYRIGHT =
  '';
